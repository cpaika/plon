...
mod list_view_tests {
    ...
    fn test_status_color_mapping() {
        ...
        assert_eq!(
            get_status_color(&TaskStatus::Done),
...
mod goal_tests {
    ...
    fn test_goal_progress_calculation() {
        ...
        let task_statuses = vec![(task1_id, true), (task2_id, false), (task3_id, true)];
...
mod performance_tests {
    ...
    fn test_large_task_list_performance() {
        ...
        let filtered: Vec<_> = tasks.iter().filter(|t| t.title.contains("5")).collect();
