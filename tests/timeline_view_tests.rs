...
use plon::domain::{task::Task, goal::Goal, resource::Resource};
...
mod timeline_view_stability_tests {
    ...
    fn test_rapid_view_changes_cause_jumping() {
        ...
        assert_eq!(view.start_date, initial_start_date, "Start date changed after view switches!");
        assert_eq!(view.days_to_show, 30, "Days to show changed after view switches!");
    }
}