...
async fn test_map_view_task_creation() {
    ...
    let tasks_in_area = service
        .repository
        .tasks
        .find_in_area(50.0, 150.0, 150.0, 250.0)
        .await
        .unwrap();
...
async fn test_map_view_clustering() {
    ...
    let cluster_centers = vec![(100.0, 100.0), (500.0, 500.0), (200.0, 400.0)];
    ...
    let area1 = service
        .repository
        .tasks
        .find_in_area(50.0, 150.0, 50.0, 150.0)
        .await
        .unwrap();
    ...
    let area2 = service
        .repository
        .tasks
        .find_in_area(450.0, 550.0, 450.0, 550.0)
        .await
        .unwrap();
