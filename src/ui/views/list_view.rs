...
impl ListView {
    ...
    pub fn show(&mut self, ui: &mut Ui, tasks: &mut Vec<Task>, resources: &[Resource]) {
            ...
            for task in tasks.iter_mut() {
                ...
                ui.horizontal(|ui| {
                    ...
                    let status_color = match task.status {
                        ...
                        crate::domain::task::TaskStatus::InProgress => egui::Color32::from_rgb(100, 150, 255),
                        crate::domain::task::TaskStatus::Done => egui::Color32::from_rgb(100, 255, 100),
