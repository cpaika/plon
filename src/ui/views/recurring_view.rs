...
impl RecurringView {
            ...
            ui.group(|ui| {
                    ...
                    && let Some(svc) = service
                {
                    ...
                    match rt.block_on(self.create_template(svc)) {
                        ...
                        Err(e) => {
                            self.error_message = Some(format!("Failed to create template: {}", e))
                        }
                    }
                }
    ...
    fn show_template_card(
        &mut self,
        ui: &mut Ui,
        template: &RecurringTaskTemplate,
        service: Option<&RecurringService>,
    ) {
        ui.group(|ui| {
            ui.horizontal(|ui| {
                // Status indicator
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    let toggle_hover = if template.active {
                        "Deactivate"
                    } else {
                        "Activate"
                    };
            ...
            ui.horizontal(|ui| {
                ...
                ui.label(format!(
                    "Generated: {} times",
                    template.recurrence_rule.occurrences_count
                ));
            });
